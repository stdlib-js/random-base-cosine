...
/**
* Interface for generating pseudorandom numbers from a raised cosine distribution with pre-specified parameter values.
*/
...
/**
* Interface for generating pseudorandom numbers from a raised cosine distribution without pre-specified parameter values.
*/
...
interface Random extends PRNG {
	...
	*
	* @example
	* var mycosine = cosine.factory( 0.0, 1.0 );
	* var v = mycosine();
	* // returns <number>
	*
	* @example
	* var mycosine = cosine.factory( -3.0, 0.5, {
	*     'seed': 297
	* });
	* var v = mycosine();
	* // returns <number>
	...
	*
	* @example
	* var mycosine = cosine.factory();
	* var v = mycosine( 0.0, 1.0 );
	* // returns <number>
	*
	* @example
	* var mycosine = cosine.factory({
