...
```javascript
import cosine from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-cosine@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-cosine@v0.2.1-deno/mod.js';
```
